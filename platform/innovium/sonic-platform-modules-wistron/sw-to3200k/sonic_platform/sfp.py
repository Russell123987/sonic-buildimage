...
class Sfp(SfpBase):
    ...
    def get_transceiver_bulk_status(self):
        ...
        #QSFP-DD
            ...
            if self.dom_channel_monitor_supported:
                offset = 0
                dom_data_raw = self._read_eeprom_specific_bytes((offset + QSFP_DD_CHANNL_MON_OFFSET), QSFP_DD_CHANNL_MON_WIDTH, 11)
                start = 0
                end = 48
    ...
    def get_transceiver_threshold_info(self):
        ...
        #QSFP-DD
            ...
            offset = 128
            dom_module_threshold_raw = self._read_eeprom_specific_bytes((offset + QSFP_DD_MODULE_THRESHOLD_OFFSET), QSFP_DD_MODULE_THRESHOLD_WIDTH, 2)
            if dom_module_threshold_raw is None:
                return transceiver_dom_threshold_info_dict
